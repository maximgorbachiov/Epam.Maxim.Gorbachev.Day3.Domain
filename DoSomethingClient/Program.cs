    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            var input = new Input
            {
                Users = new User[]
                {
                    new User { Id = 1, Name = "Vasily", Age = 23 },
                    new User { Id = 2, Name = "Semen", Age = 35 },
                    new User { Id = 3, Name = "Pawel", Age = 22 }
                }
            };
        ...
        private static void Method2(Input input)
        {
            ...
            try
            {
                ...
                Result result1 = loader.LoadFrom(path, input);
                Console.WriteLine("Method2 first value: {0}", result.Value);
                Console.WriteLine("Method2 second value: {0}", result1.Value);
            }
            catch (Exception e)
            {
                Console.WriteLine("Exception: {0}", e.Message);
